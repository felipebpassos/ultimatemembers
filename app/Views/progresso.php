    ...
    <div class="row" style="margin-bottom: 40px;">
        ...
        <div class="quadro-container col-md-6">
            <div class="quadro mb-4">
                <h3>Geral</h3>
                <div class="dados" style="margin-left: 50px;">
                ...
                <div class="graph-progress" style="right:80px;">
                    <?php
                    ...
                    <div class="circular-progress">
                        <div class="outer">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="120px" height="120px">
                                <defs>
                                    <radialGradient id="GradientColor" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
                                        <stop offset="0%" style="stop-color:#989898; stop-opacity:1" />
                                        <stop offset="100%" style="stop-color:#3f3f3f; stop-opacity:1" />
                                    </radialGradient>

                                </defs>
                                <circle id="progress-circle" cx="60" cy="60" r="50" stroke-linecap="round" />
                            </svg>
                        </div>
                    </div>
            ...
            <div class="quadro mb-4">
                <h3>Comunidade</h3>
                <!-- Adicione as estatísticas da comunidade aqui -->
            </div>
        ...
        <div class="quadro-container col-md-6">
            ...
            <div class="quadro mb-4">
                ...
                <div class="graph-progress" style="width: 160px; height: 160px;">
