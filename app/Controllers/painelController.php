...
class painelController extends Controller
{
    ...
    public function preferencias()
    {
        ...
        $data['scripts_head'] = array('abas', 'select');
        $data['scripts_body'] = array('btn-selected', 'toggleSearch', 'menu-responsivo', 'simple_select', 'dropdown-exportar', 'usuarios-table', 'pop-ups', 'troca_img', 'colorPickr', 'deletar-btn-adm', 'mostra_senha');
